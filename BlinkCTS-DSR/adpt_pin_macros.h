...
#define LED_input DDRA &= ~_BV(PA4)
#define FTDI_nDSR_input DDRA &= ~_BV(PA5)
...
#define LED_output DDRA|= _BV(PA4)
#define FTDI_nDSR_output DDRA|= _BV(PA5)
...
#define LED_high PORTA|= _BV(PA4)
#define FTDI_nDSR_high PORTA|= _BV(PA5)
...
#define LED_low PORTA &= ~_BV(PA4)
#define FTDI_nDSR_low PORTA &= ~_BV(PA5)
...
#define LED_read PINA & _BV(PA4)
#define FTDI_nDSR_read PINA & _BV(PA5)
